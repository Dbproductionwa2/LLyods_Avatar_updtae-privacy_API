...
public class VRKeyboardManager : MonoBehaviour
{
	...
	XRRayInteractor leftRayIntersector;
	...
	{
		localVRPlayerCamera = GameObject.Find("/aatest1(Clone)/XR Rig/Camera Offset/Main Camera");
		leftBaseController = GameObject.Find("/aatest1(Clone)/XR Rig/Camera Offset/LeftHand Parent/LeftHand Base Controller");
		rightBaseController = GameObject.Find("/aatest1(Clone)/XR Rig/Camera Offset/Right Hand Parent/RightHand Base Controller");
		...
		leftRayIntersector = leftBaseController.GetComponent<XRRayInteractor>();
		leftRayIntersector.enabled = false;
